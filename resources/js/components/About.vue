<template>
    <div>
    <!-- img width 100%-->
    <!--<img src="img/grivibutikk.png" class="about-us-pic" alt="Instagram" /> -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <img src="img/grivibutikk.png" class="pb-3" alt="old picture of grivi" height="341.52px" />
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12">
            <p class="section-description">
            ...
            <img src="img/grivibutikk2.png" alt="picture of grivi window" height="341.52px" />
          </div>
        </div>
      </div>
    </div>
